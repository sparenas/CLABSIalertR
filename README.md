...
The official development version of CLABSIalertR is hosted on GitHub:
...
If you have downloaded the source package (CLABSIalertR_0.0.0.9000.tar.gz), you may install it locally with:
